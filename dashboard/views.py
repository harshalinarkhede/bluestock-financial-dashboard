...
def home(request):
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <div>
                ...
                <a href="/compare/" class="btn btn-outline-light me-2">
                    Compare
                </a>

                <a href="/screener/" class="btn btn-outline-light me-2">
                    Screener
                </a>
    ...
    <a href="/companies/" class="btn btn-primary m-1">
        Companies
    </a>

    <a href="/compare/" class="btn btn-success m-1">
        Compare
    </a>

    <a href="/screener/" class="btn btn-warning m-1">
        Screener
    </a>

    <a href="/sector/banking/" class="btn btn-info m-1">
        Banking Sector
    </a>

    <a href="/api/companies/" class="btn btn-dark m-1">
        API
    </a>

    <a href="/logout/" class="btn btn-danger m-1">
        Logout
    </a>
